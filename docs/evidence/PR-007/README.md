...
This is an unmerged candidate in [draft PR #11](https://github.com/xsparc/omniweft/pull/11). Hosted Windows/Linux checks were not_run at local evidence capture; the PR tracks current checks. No merge gate is waived.
