...
Status: **planned specification; not implemented**. Work item: **PR-026 — Forces, impulses and body state**.

Dependencies: PR-007, PR-025. Validation lanes: cpu.
...
```sh
omniweft_examples --example physics.agent_push --headless --seed 7 --verify --output artifacts/physics.agent_push
```

## Pass criteria

Apply an isolated impulse with known mass and expected velocity within tolerance, plus a sustained-force fixture.

## Negative and recovery cases

Unauthorized physical actions, invalid vectors and expired tick windows fail; sleeping bodies wake as specified.
