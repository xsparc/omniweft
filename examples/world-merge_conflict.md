# world.merge_conflict

Status: **planned specification; not implemented**. Work item: **PR-032 — Explicit branch diff and merge**.

Dependencies: PR-011, PR-031. Validation lanes: cpu.
...
```sh
omniweft_examples --example world.merge_conflict --headless --seed 7 --verify --output artifacts/world.merge_conflict
```

## Pass criteria

Merge disjoint supported edits using explicit base/live/branch revisions and preserve untouched live data.

## Negative and recovery cases

Conflicting edit/delete cases return a diff; failed merge changes nothing and never uses silent last-writer-wins.
