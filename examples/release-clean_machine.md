# release.clean_machine

Status: **planned specification; not implemented**. Work item: **PR-038 — Developer-preview packaging**.

Dependencies: PR-035, PR-037. Validation lanes: cpu, gpu, manual.
...
```sh
omniweft_examples --example release.clean_machine --gpu --seed 7 --verify --output artifacts/release.clean_machine
```
...
Package and launch headless/editor/SDK/examples on clean Windows/Linux machines; verify checksums, licenses/SBOM and documented install.

## Negative and recovery cases

Missing mandatory runtime files or notices block packaging; no secrets, proprietary fixtures or unverified release claims.
