# physics.edit_active_body

Status: **planned specification; not implemented**. Work item: **PR-028 — Atomic publication of physical edits**.

Dependencies: PR-012, PR-026, PR-027. Validation lanes: cpu, gpu.
...
```sh
omniweft_examples --example physics.edit_active_body --gpu --seed 7 --verify --output artifacts/physics.edit_active_body
```
...
Publish static terrain or supported convex replacement and collider together; verify raycasts, wake and mass/velocity policy.

## Negative and recovery cases

Reject unsupported dynamic concave edits and invalid overlap; no visual/collision revision mismatch.
