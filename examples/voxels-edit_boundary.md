# voxels.edit_boundary

Status: **planned specification; not implemented**. Work item: **PR-023 — Sparse voxel storage and edits**.

Dependencies: PR-003, PR-016. Validation lanes: cpu.
...
```sh
omniweft_examples --example voxels.edit_boundary --headless --seed 7 --verify --output artifacts/voxels.edit_boundary
```

## Pass criteria

Fill/carve/paint across positive and negative chunk boundaries; verify exact cells, revisions and persistence.

## Negative and recovery cases

Bounds/allocation overflow and conflicting chunk revisions reject the batch without allocating unbounded chunks.
