...
PR-007 scoped capabilities and resource budgets are implemented as a local candidate, with delivery and cross-platform validation pending. See [policy.denied_edits](examples/policy-denied_edits.md) and its [handoff](docs/execution/PR-007-HANDOFF.md).
