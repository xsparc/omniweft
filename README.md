...
PR-007 scoped capabilities and resource budgets are merged in [PR #11](https://github.com/xsparc/omniweft/pull/11), with a reproduced post-merge Windows SDK compatibility issue under [bounded repair](docs/execution/PR-007-COMPATIBILITY-HANDOFF.md). See [policy.denied_edits](examples/policy-denied_edits.md) and its [handoff](docs/execution/PR-007-HANDOFF.md).
