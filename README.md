...
PR-007 scoped capabilities and resource budgets are implemented as a local candidate, with local Windows/Linux CPU validation passed and delivery/hosted validation pending. See [policy.denied_edits](examples/policy-denied_edits.md) and its [handoff](docs/execution/PR-007-HANDOFF.md).
